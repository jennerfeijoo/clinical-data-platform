...
A complete per-file reference is distributed as a companion PDF generated for the repository architecture review. The PDF describes the objective, composition, and function of every tracked repository file.
